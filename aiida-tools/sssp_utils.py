...
pseudo_families_libraries_dict = {'pslib.0.3.1_PBE_US': '031US',
                                  ...
                                  'pslib.1.0.0_PBE_US_low_acc': '100US (low)',
                                  'pslib.1.0.0_PBE_PAW_low_acc': '100PAW (low)',
...
def bands_distance_inline(parameters,bandsdata1,bandsdata2):
    ...
    if input_nelec==False:
        ...
        if delta_n1>0:
            bands1=bands1[:,int(delta_n1):]
            nb1=num_bands1-delta_n1
        else:
            nb1=num_bands1
        if delta_n2>0:
            bands2=bands2[:,int(delta_n2):]
